...
const firendsArrayPhoneName = firendsArray.map(function(element,index) {
    return({
...
console.log(firendsArrayPhoneName)
...
const friendMoreThan = firendsArray.filter(function(element,index) {
...
const database = [
    ...
    const deathMoreFiveDatabase = database.filter(function(element,index) { //กรองสมาชิกออกมาตามเงื่อนไขที่กำหนด
        ...
        return element.province.includes('กรุง')
    })
